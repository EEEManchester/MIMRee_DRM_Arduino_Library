...
enum lhm_command_id_t : uint16_t
{
    ...
    LHM_CMD_ID_HINGE_POWER_OFF = 10,
    LHM_CMD_ID_HINGE_TAKE_OFF = 11,
    LHM_CMD_ID_HINGE_LANDING = 12,
    LHM_CMD_ID_HINGE_SWING_REDUCTION = 13,
    LHM_CMD_ID_HOOK_POWER_OFF = 20,
    LHM_CMD_ID_HOOK_CLOSE = 21,
    LHM_CMD_ID_HOOK_OPEN = 22,
    LHM_CMD_ID_RESET_DYNAMIXEL_COM = 90,
