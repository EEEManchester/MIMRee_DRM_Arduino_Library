...
#define PIN_PE_SENSOR 8                //white
#define PIN_JETTISON_SERVO_PWM 3       //white
...
const uint16_t MOTION_SEQ_LANDING[] = {5, MOTOR_ID_HINGE_ROLL, HINGE_POS_VERTICAL, 70, MOTOR_ID_HINGE_PITCH, 1100, 100, MOTOR_ID_HINGE_ROLL, 1024, 70, MOTOR_ID_HINGE_PITCH, 760, 50, MOTOR_ID_HINGE_ROLL, 800, 50};

//OpenCM 9.04 + 485 EXP specific
#define PIN_BUTTON_JETTISON PIN_BUTTON_1
#define PIN_BUTTON_SD_LOGGER PIN_BUTTON_2
...
enum lhm_command_id_t : uint8_t
{
    ...
    LHM_CMD_ID_RESET_ALL_SERVOS = 71,
    LHM_CMD_ID_RESET_HINGE_SERVO_ERROR = 72,
...
enum lhm_hinge_status_t : uint8_t
{
    ...
    LHM_HINGE_STATUS_SERVO_HARDWARE_ERROR,
